...
FRONTAL_FACE_XML = './haarcascade_frontalface_default.xml'
...
t0 = perf_counter()
# im_link = project_folder + '/img_align_celeba/img_align_celeba/000907.jpg'
im_link = 'C:/Users/hoang/Downloads/test_image.jpg'
print("Initializing detector..")
t1 = perf_counter()
detector = MasterPredictor()
t2 = perf_counter()
print("Initialization complete. Elapse d time: {}s".format(t2-t1))
img, predictions = detector.detect_image(im_link)
t3 = perf_counter()
print("Time to predict an image: {:.3f}s".format(t3-t2))
plt.imshow(img)
print(predictions)